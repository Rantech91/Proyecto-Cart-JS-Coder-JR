...
carrito.forEach((object) => {
  mostrarCarro.innerHTML += `
    ...
    <i class="fa-solid fa-minus bg-white rounded-full p-1 mr-2" onclick="minus(${object.id})"></i>
  
      
      ${object.quantity}
      <i class="fa-solid fa-plus bg-white rounded-full p-1 ml-2" onclick="plus(${object.id})"></i>
    </div>
  `
})
